...
def run_sections(sections, project_id, editor, auditor, fresh_sources, prev_round_outputs, language_hint, max_tokens):
    """
    ...
    for sec in tqdm(sections,
        ...
        draft = self.editor.draft_section(
            sec, ev, self.language_hint ,
